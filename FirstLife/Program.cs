...
namespace FirstLife
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            for (var i = 0; i < 23; i++)
            {
                var life = new Life(world, rnd.NextDouble(), rnd.NextDouble());
                world.Add(life);
            }
            ...
            var name = $"fuck";
            var outputFilePath = name.Replace(":", "_") ;
            VideoMaker.NewWriter(outputFilePath, width, height);
